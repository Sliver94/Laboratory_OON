...
alpha = 0.2  # Loss coefficient [dB/km]
beta2 = 2.13e-26  # Dispersion [(m Hz^2)^-1]
gamma = 1.27e-3  # Non-linear coefficient [(m W)^-1]
# f_max = 191.2e12
# f_min = 195.6e12
# df = (f_max - f_min) / number_of_channels
df = 50e9  # Channel spacing
Rs = 32e9  # Symbol rate
Bn = 12.5e9  # Noise bandwidth
BERt = 10e-3  # Bit Error Rate
